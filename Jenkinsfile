pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://54.152.213.189:9090/manager/text'
        TOMCAT_USER = 'Admin'
        TOMCAT_PASS = 'Admin'
    ...
    post {
        success {
            echo "✅ Backend deployed: http://54.152.213.189:9090/springapp1"
            echo "✅ Frontend deployed: http://54.152.213.189:9090/frontapp1"
        }
        failure {
